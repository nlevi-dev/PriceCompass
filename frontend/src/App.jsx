...
function App() {
    ...
    useEffect(() => {
        const deserializeData = async () => {
            try {
                const deserialized = await deserializeBin(binData, language);
                setDeserializedData(deserialized);
            } catch (error) {
    ...
    if (selectedItem || datePickerOpen) {
    ...
    return (<React.Fragment>
            ...
            <header className="ribbon sticky top-0 p-4 bg-gray-500 z-10">
                ...
                <div>
                    <div className="flex items-center">
                        <p>Date:&nbsp;</p>
                        <DatePicker
                            validDateRanges={settings.valid_date_ranges}
                            rawDate={rawDate}
        ...
        {/* Items Link Section */}
        {data !== null && (selectedItem) && (<div className="item_popup" onClick={() => setSelectedItem(null)}>
            <div className="item_popup_inner1" onClick={(event) => event.stopPropagation()}>
